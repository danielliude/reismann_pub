...
/***/ function(module, exports, __webpack_require__) {
	...
	//import '../vendors/AdminLTE/css/skins/skin-blue.css'
...
/***/ function(module, exports, __webpack_require__) {
	...
	function match(a){return DIACRITICS[a] || a;}return text.replace(/[^\u0000-\u007E]/g,match);}function matcher(_x,_x2){var _again=true;_function: while(_again) {var params=_x,data=_x2;_again = false; // Always return the object if there is nothing to compare
	...
	_x = params;_x2 = match;_again = true;match = c = child = matches = undefined;continue _function;}var original=stripDiacritics(data.text).toUpperCase();var term=stripDiacritics(params.term).toUpperCase(); // Check if the text contains the term
	...
	if($.inArray(options,thisMethods) > -1){return this;}return ret;}else {throw new Error('Invalid arguments for Select2: ' + options);}};}if($.fn.select2.defaults == null){$.fn.select2.defaults = Defaults;}return Select2;}); /*!
	...
	S2.define('jquery.mousewheel',['jquery'],factory);}else if(true){ // Node/CommonJS style for Browserify
	...
	return special.settings.adjustOldDeltas && orgEvent.type === 'mousewheel' && absDelta % 120 === 0;}}); // Return the AMD loader configuration so it can be used outside of this file
