        ...
        for (var i in ret) {
            html += '<div class="column">' +
                      '<div class="ui segment padding">'+
                        '<a href="' + ret[i].profile_url + '" class="profile_map" style="background-image: url(\'' + ret[i].card_image_url +'\');"></a>' +
                        '<a href="' + ret[i].profile_url + '" class="ui tiny circular image">' +
                          '<img  src="' + ret[i].avatar_url + '" alt="User Avatar">' +
                        '</a>' +
                        '<div class="ui segment">' +
                          '<div class="row"> ' +
                            '<div class="ui header">' + ret[i].username + ' '  + ret[i].short_description + '</div>' +
                            '<span>' + ret[i].location + '</span>' +
                          '</div>' +
                          '<div class="row">' +
                            '<table class="ui very basic unstackable compact table"><tbody>' 
