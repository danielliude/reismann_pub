...
from profiles import views as accounts_views
...
urlpatterns = patterns('',
    ...
    url(r'^(?P<username>[\@\.\w-]+)/disabled/$',
       accounts_views.disabled_account,
    ...
    url(r'^page/(?P<page>[0-9]+)/$',
       accounts_views.ProfileListView.as_view(),
    ...
    # Edit contact
    url(r'^(?P<username>[\@\.\w-]+)/edit_contact/$',
       accounts_views.edit_contact,
       name='edit_contact'),
)
